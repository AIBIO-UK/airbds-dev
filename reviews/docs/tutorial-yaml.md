...
The question text and guidance for each ID are in [`metric/airbds_metric_v1.0.yaml`](../../metric/airbds_metric_v1.0.yaml).
...
See [`metric/airbds_metric_v1.0.yaml`](../../metric/airbds_metric_v1.0.yaml) for which questions belong to each tier.
