...
> The canonical question reference — with full guidance text and weights — is in [metric/airbds_metric_v1.0.1.yaml](../../metric/airbds_metric_v1.0.1.yaml).
...
What the grades mean is explained in [reviews/GUIDANCE.md](../GUIDANCE.md); the thresholds are in the metric (`airbds_metric_v1.0.1.yaml`).
