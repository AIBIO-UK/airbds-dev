...
These run against the committed v0.5 metric, so they exercise the real grading
...
METRIC_JSON = REPO_ROOT / "metric" / "airbds_metric_v0.5.json"
METRIC_YAML = REPO_ROOT / "metric" / "airbds_metric_v0.5.yaml"
